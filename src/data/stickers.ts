...
export const STICKERS: Sticker[] = [
  ...
  { id: 'donghak-flag', period: 'modern', name: '동학농민운동 깃발', icon: 'i240', hintLine: '동학농민군은 나라를 돕고 백성을 편안하게 한다는 뜻의 보국안민(輔國安民)을 깃발에 내걸고 낡은 제도를 고치려 했다.', contentReviewNeeded: true, sourceNote: '그림은 태극·글자 없는 낡은 천 깃발. 기록이 확실한 것은 한자 輔國安民 을 쓴 동도대장기이고, 태극 도안(오지영 보국안민 태극기 목판)은 실제 게양 여부가 미확인이라 그림에서 뺐다. 보국안민은 설명 문장으로 다룬다' },
