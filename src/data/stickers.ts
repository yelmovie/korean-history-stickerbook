...
export const STICKERS: Sticker[] = [
  ...
  { id: 'sumbe-point', period: 'prehistoric', name: '슴베찌르개', icon: 'i117', hintLine: '슴베찌르개는 자루에 꽂아 쓰던 구석기 시대의 뗀석기이다.', contentReviewNeeded: true },
  ...
  // ----- 근현대 -----
  { id: 'independent-news', period: 'modern', name: '독립신문', icon: 'i136', hintLine: '독립신문은 한글로 소식을 전하며 자주 독립 의식을 높이고자 한 신문이다.', contentReviewNeeded: true },
